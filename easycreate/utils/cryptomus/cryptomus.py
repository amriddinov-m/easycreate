...
class Cryptomus:
    ...
    def add_payment(self,
        ...
        if "result" in response:
            res = response["result"]
            with open("cryptomus.json", "w") as f:
    ...
    def send_test_webhook_payment(self, url_callback: str, currency: str, network: str, uid: str = None, order_id: str = None, status: str = "paid"):
        ...
        # if res['state'] == 0:
        #     return models.SendTestWebhooSuccess(**res)
        # return models.SendTestWebhooError(**res)